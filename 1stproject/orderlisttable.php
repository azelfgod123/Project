...
<div class="container">
  ...
  <div class="p-3 mb-2 bg-light fw-bold"><i class="fas fa-info-circle mr-1"></i> ORDER TABLE</div>
...
<div class="d-flex " style="border: 0px solid black; ">
  ...
  <thead class="table-dark">
    <tr >
      <th class="fw-light">OrderID</th>
      <th class="fw-light">CustomerID</th>
      <th class="fw-light">OrderDetailsID</th>
      <th class="fw-light">OrderAmount</th>
      <th class="fw-light">OrderStatus</th>
      <th class="fw-light">EncoderID</th>
      ...
      <tbody class="color">
        ...
        if($result->num_rows>0){
         ...
         while($row=$result->fetch_assoc()){
          ...
          $orderdetails_id =$row["OrderDetailsID"];
          $order_amt = $row["OrderAmount"];
          $order_stat = $row["OrderStatus"];
          $encoder_id = $row["EncoderID"];
          $remarks = $row["Remarks"];
