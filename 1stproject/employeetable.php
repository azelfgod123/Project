...
<script>
  ...
  $('table tr').click(function(){
    var id = $(this).attr('row_id');
        window.open("http://localhost/1stproject/Employee_Info-Edit.php?id=" + id );
  });
}); 
...
<div class="container">
  ...
  <div class="p-3 mb-2 bg-light fw-bold"><i class="fas fa-info-circle mr-1"></i> EMPLOYEE TABLE</div>
...
<div class="d-flex " style="border: 0px solid black; ">
  ...
  <nav >
   <input type="search" id = "search" class="firstname text text-box">
      ...
      <div class="mx-3">
        <a href="Employee_Insert.php" style="text-decoration: none;"><div class="wrap"><button class="button">ADD EMPLOYEE</button></div>
          </a>
      </div>
  ...
  <thead class="table-dark">
    <tr >
      <th class="fw-light">Encoder ID</th>
      <th class="fw-light">Employee Name</th>
      <th class="fw-light">BirthDate</th>
      <th class="fw-light">Gender</th>
      ...
      <tbody class="color">
        ...
        if($result->num_rows>0){
         ...
         while($row=$result->fetch_assoc()){
          ...
          $order_id = $row["EncoderID"];
          $customer_id = $row["FirstName"];
          $orderdetails_id =$row["MidName"];
          $order_amt = $row["LastName"];
          $order_stat = $row["BirthDate"];
          $encoder_id = $row["Gender"];
          $remarks = $row["Address"];
          ...
          "<tr row_id='$order_id'>
            <td>$order_id</td>" 
          ."<td>$customer_id "."$orderdetails_id "."$order_amt</td>"
          ."<td>$order_stat</td>"
          ."<td>$encoder_id</td>"
          ."<td>$remarks</td>"
          ."<td>$contact</td>"
