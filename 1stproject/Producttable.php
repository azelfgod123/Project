...
<script>
  ...
  $('table tr').click(function(){
    ...
    window.location.href='http://localhost/Project/1stproject/product_Info-Edit.php?id=' + id;
  });
}); 
...
<div class="container">
  ...
  <div class="p-3 mb-2 bg-light fw-bold"><i class="fas fa-info-circle mr-1"></i> PRODUCT TABLE</div>
...
<div class="d-flex " style="border: 0px solid black; ">
  ...
  <nav >
   <input type="search" id = "search" class="firstname text text-box">
      ...
      <div class="mx-3">
        <a href="product_Insert.php" style="text-decoration: none;"><div class="wrap"><button class="button">ADD PRODUCT</button></div>
          </a>
      </div>
      ...
      <tbody class="color">
        ...
        if($result->num_rows>0){
         ...
         while($row=$result->fetch_assoc()){
          ...
          $order_id = $row["ProductID"];
          $customer_id = $row["ProductName"];
          $orderdetails_id =$row["Description"];
          $order_amt = $row["Category"];
          $order_stat = $row["Status"];
          $encoder_id = $row["Price"];
          $remarks = $row["Unit"];
