...
<script>
  ...
  $('table tr').click(function(){
    ...
    window.location.replace("Customer_Info-Edit.php?customerid=" + id);
  });
}); 
...
<div class="container">
  ...
  <div class="p-3 mb-2 bg-light fw-bold"><i class="fas fa-info-circle mr-1"></i> CUSTOMER TABLE</div>
...
<div class="d-flex " style="border: 0px solid black; ">
  ...
  <thead class="table-dark">
    <tr >
      <th class="fw-light">CustomerID</th>
      <th class="fw-light">CustomerName</th>
      <th class="fw-light">OfficeAddress</th>
      <th class="fw-light">ContactNo</th>
      <th class="fw-light">EmailAddress</th>
      <th class="fw-light">CustomerStatus</th>
      ...
      include 'connection.php';
        ...
        if($result->num_rows>0){
         ...
         while($row=$result->fetch_assoc()){
          ...
          $order_id = $row["CustomerID"];
          $customer_id = $row["CustomerName"];
          $orderdetails_id =$row["OfficeAddress"];
          $order_amt = $row["ContactNo"];
          $order_stat = $row["EmailAddress"];
          $encoder_id = $row["CustomerStatus"];
          $remarks = $row["Remarks"];
